    ...
    <main className="min-h-screen bg-gray-50 py-10 px-4 relative">
      ...
      >
        ...
        <div className="bg-white rounded-2xl shadow-md p-8 flex flex-col gap-4">
          <h2 className="text-base font-bold text-gray-800">발급 내역</h2>
      ...
      {!unlocked && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/30 backdrop-blur-[2px]">
          <form
            ...
            className="bg-white rounded-2xl shadow-xl p-8 flex flex-col gap-4 w-full max-w-sm mx-4"
          >
            <div className="flex flex-col items-center gap-1 mb-1">
              ...
              <h1 className="text-lg font-bold text-gray-800">관리자 인증</h1>
              <p className="text-xs text-gray-400">관리자 비밀번호를 입력하세요.</p>
            </div>
            ...
            <Link href="/" className="text-xs text-gray-400 text-center hover:text-gray-600">
              ← 홈으로
            </Link>
          </form>
        </div>
